  ...
  return (
    <section
      ...
      <div className="relative z-20 mx-auto flex w-full max-w-7xl flex-col items-center px-6 text-center">
        ...
        <h1 className="max-w-5xl text-3xl font-extrabold leading-tight tracking-tight md:text-4xl lg:text-5xl">
          Build Stronger
          <br />
          Glutes.
          <br />
        ...
        <p className="mt-6 max-w-3xl text-lg leading-relaxed text-gray-200 sm:text-xl md:text-2xl">
        ...
        <div className="mt-8 flex flex-col gap-5 sm:flex-row">
          ...
          <button
            ...
            className="cursor-pointer rounded-full bg-white px-10 py-4 text-lg font-bold text-black shadow-2xl transition-all duration-300 hover:scale-105 hover:bg-gray-200">
            Shop Now
          </button>
          ...
          <button
            ...
            className="cursor-pointer rounded-full border-2 border-white px-10 py-4 text-lg font-bold transition-all duration-300 hover:scale-105 hover:bg-white hover:text-black">
            View Workouts
          </button>
